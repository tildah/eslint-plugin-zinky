 ...
 * than the values provided in configuration taking into account ZinkyJS 
 * specificities.
 * @author Burawi Ben Ammar
 */
    ...
    create(context) {
        ...
        return {
            Identifier(node) {
                ...
                const methodsRE = new RegExp(`^(${methods.join("|")})_`);
                const name = node.name.replace(methodsRE, "");
